...
- [`meta_039_legacy_formula_parity_and_zero_backfill.md`](00-meta/meta_039_legacy_formula_parity_and_zero_backfill.md): paridad de calculo legacy y ceros explicitos.
- [`meta_040_formula_builder_component_refactor.md`](00-meta/meta_040_formula_builder_component_refactor.md): primer corte de componentes del Formula Builder.
