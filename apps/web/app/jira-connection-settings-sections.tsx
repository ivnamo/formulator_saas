...
type JiraConnectionFormFieldsProps = {
...
export function JiraConnectionFormFields({
  jiraConnectionForm,
  canEditTenantData,
  onJiraConnectionFormChange,
}: JiraConnectionFormFieldsProps) {
  return (
    <>
      <label>
        <span>Auth</span>
...
type JiraConnectionActionButtonsProps = {
  canEditTenantData: boolean;
...
export function JiraConnectionActionButtons({
  canEditTenantData,
...
}: JiraConnectionActionButtonsProps) {
  return (
...
type JiraConnectionSummaryProps = {
  activeJiraConnection: JiraConnection | null;
};

export function JiraConnectionSummary({
  activeJiraConnection,
}: JiraConnectionSummaryProps) {
  if (!activeJiraConnection) {
    return <div className="empty">No Jira connection saved.</div>;
  }
